...
module.exports = async function (context, req) {
    ...
    let download = ""
    let downloadpng = "https://bitproj8112.blob.core.windows.net/images/" + username + ".png";
    let downloadjpg = "https://bitproj8112.blob.core.windows.net/images/" + username + ".jpeg";
